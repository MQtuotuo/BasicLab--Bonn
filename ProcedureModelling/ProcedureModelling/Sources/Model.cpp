...
/*
Model.cpp reads output of Parsing and generates Derivation Tree.
*/
...
namespace model
{
	...
	void Modelling::Model(std::unordered_map < std::string, std::vector<attribute::Rule>> ruleSet)
	{
		/*
	...
	attribute::Symbol* Modelling::GenerateTestData()
	{
		attribute::Symbol* node = new Symbol();
		return node;
	}

	void Modelling::print(Symbol* item){
		/*
	...
	int Modelling::nextInt(string s){
		return stoi(s);
	}
	//  helper function to parse string
	double Modelling::nextDouble(string s){
		return stod(s);
	}
	...
	*/
	void Modelling::nullFunction(vector<string>childSymbolNames, Symbol* Parent){
		/*
	...
	void Modelling::comp(vector<string> childSymbolNames, Symbol* Parent){
		//create Children
	...
	void Modelling::insertMap1(int id, string symbolName){
	...
	void Modelling::subDiv(vector<string> parameterValues, vector<string> childSymbolNames, Symbol* Parent){
	...
	void Modelling::repeat(vector<string> parameterValues, vector<string> childSymbolNames, Symbol* Parent){
	...
	void Modelling::S(vector<string> parameterValues, vector<string> childSymbolNames, Symbol* Parent){
